...
Function vstCreateRigFromGuide_Execute()
	' prevent property editors from opening
	' XSI will reset this preference when the script is done executing
	...
	' import the ValveBiped.emdl
 	attach_skeleton

	'--cut hand
	CutObj "ValveBiped.RHandRoot"
	CutObj "ValveBiped.LHandRoot"
	...
	'-- SpineControl
	'-Create Objects
	CreatePrim "Sphere", "NurbsSurface", "SpineControl"
	SetValue "SpineControl.surfmsh.geom.subdivu", 4
	SetValue "SpineControl.surfmsh.geom.subdivv", 2
	AddProp "Display Property"
	SetValue "SpineControl.display.staticsel", 0
	SetValue "SpineControl.display.intsel", 0
	SetValue "SpineControl.display.playbacksel", 0
	SetValue "SpineControl.display.staticunselnear", 0
	SetValue "SpineControl.display.intunselnear", 0
	SetValue "SpineControl.display.playbackunselnear", 0
	SetValue "SpineControl.display.staticunselfar", 0
	SetValue "SpineControl.display.intunselfar", 0
	SetValue "SpineControl.display.playbackunselfar", 0

	GetPrim "Null", "SpineControlParent"
	GetPrim "Null", "SpineControlConstrainer"
	...
	'--ClavicleControlL
	GetPrim "Null", "ClavicleControlParentL"
	...
	'ClavicleControlR
	GetPrim "Null", "ClavicleControlParentR"
	Duplicate "ValveBiped.HeadControl", , 2, 1, 1, 0, 0, 1, 0, 1
	...
	'######HandControl Setup
	'--LeftHand
	GetPrim "Null", "HandControlPosParentL"
	CopyPaste "HandControlPosParentL", , "ValveBiped", 1
	ApplyCns "Position", "ValveBiped.HandControlPosParentL", "ValveBiped.LShouldereff"

	GetPrim "Null", "HandControlRotGrandmaL"
	CopyPaste "HandControlRotGrandmaL", , "ValveBiped", 1
	ApplyCns "Pose", "ValveBiped.HandControlRotGrandmaL", "ValveBiped.Bip01_L_Forearm"

	'--HandControlPosL
	GetPrim "Sphere", "HandControlPosL"
	AddProp "Display Property"
	SetValue "HandControlPosL.display.staticsel", 0
	SetValue "HandControlPosL.display.intsel", 0
	SetValue "HandControlPosL.display.playbacksel", 0
	SetValue "HandControlPosL.display.staticunselnear", 0
	SetValue "HandControlPosL.display.intunselnear", 0
	SetValue "HandControlPosL.display.playbackunselnear", 0
	SetValue "HandControlPosL.display.staticunselfar", 0
	SetValue "HandControlPosL.display.intunselfar", 0
	SetValue "HandControlPosL.display.playbackunselfar", 0
	...
	'--HandControlRotL
	GetPrim "Null", "HandControlRotParentL"
	...
	CreatePrim "Cube", "MeshSurface", "HandControlRotL"
	...
	GetPrim "Null", "HandControlRotConstrainerL"
	...
	'--HandControlPosR
	CreatePrim "Sphere", "NurbsSurface", "HandControlPosR"
	SetValue "HandControlPosR.surfmsh.geom.subdivu", 4
	SetValue "HandControlPosR.surfmsh.geom.subdivv", 2
	AddProp "Display Property"
	SetValue "HandControlPosR.display.staticsel", 0
	SetValue "HandControlPosR.display.intsel", 0
	SetValue "HandControlPosR.display.playbacksel", 0
	SetValue "HandControlPosR.display.staticunselnear", 0
	SetValue "HandControlPosR.display.intunselnear", 0
	SetValue "HandControlPosR.display.playbackunselnear", 0
	SetValue "HandControlPosR.display.staticunselfar", 0
	SetValue "HandControlPosR.display.intunselfar", 0
	SetValue "HandControlPosR.display.playbackunselfar", 0
	...
	'--HandControlRotR
	GetPrim "Null", "HandControlRotParentR"
	...
	CreatePrim "Cube", "MeshSurface", "HandControlRotR"
	...
	GetPrim "Null", "HandControlRotConstrainerR"
	...
	CutObj
	CutObj
	CreatePrim "Sphere", "NurbsSurface", "ArmRollL"
	SetValue "ArmRollL.sphere.radius", 1
	SetValue "ArmRollL.surfmsh.geom.subdivu", 4
	SetValue "ArmRollL.surfmsh.geom.subdivv", 2
	MatchTransform "ArmRollL", "ValveBiped.LArmRoll", siTrn
	...
	CutObj
	CutObj
	CreatePrim "Sphere", "NurbsSurface", "ArmRollR"
	SetValue "ArmRollR.sphere.radius", 1
	SetValue "ArmRollR.surfmsh.geom.subdivu", 4
	SetValue "ArmRollR.surfmsh.geom.subdivv", 2
	MatchTransform "ArmRollR", "ValveBiped.RArmRoll", siTrn
	...
	CutObj
	CutObj
	CreatePrim "Sphere", "NurbsSurface", "LegRollL"
	SetValue "LegRollL.sphere.radius", 1
	SetValue "LegRollL.surfmsh.geom.subdivu", 4
	SetValue "LegRollL.surfmsh.geom.subdivv", 2
	MatchTransform "LegRollL", "ValveBiped.LLegRoll", siTrn
	SelectObj "ValveBiped.LLegRoll"
	DeleteObj "ValveBiped.LLegRoll"
	GetPrim "Null", "LegRollControlParent_L"
	...
	CutObj
	CutObj
	CreatePrim "Sphere", "NurbsSurface", "LegRollR"
	SetValue "LegRollR.sphere.radius", 1
	SetValue "LegRollR.surfmsh.geom.subdivu", 4
	SetValue "LegRollR.surfmsh.geom.subdivv", 2
	MatchTransform "LegRollR", "ValveBiped.RLegRoll", siTrn
	SelectObj "ValveBiped.RLegRoll"
	DeleteObj "ValveBiped.RLegRoll"
	GetPrim "Null", "LegRollControlParent_R"
	...
	CreateGroup "hidden_distractions"
	...
	'ws: call vstCreateToeLift.js to add the new toe controls
	'ws: 02.02.06 take this out for now, since the rotation limits that make the control work break the foot under other foot positions
'	vstCreateToeLift

	'ws: select the plotted group marking sets and key them (johnm request)
	' this should be replaced with a proper way to set the neutral/rest pose
	vstKeyValveBipedPlotted
...
Sub attach_skeleton()
	...
	' check the rig and the guide names
	vstCheckGuideNames
	'ws: check the names to make sure they match episodic
'	vstCheckBipedNames
	vstConvertBipedEpisodic
...
Function AS_Attach_Bip01_Pelvis(in_rigModel, out_valid)
	...
	s1 = GetValue("ValveGuide.Spine0_bone.bone.length")
	s2 = GetValue("ValveGuide.Spine1_bone.bone.length")
	s3 = GetValue("ValveGuide.Spine2_bone.bone.length")
	s4 = GetValue("ValveGuide.Spine3_bone.bone.length")
	...
	c4 = ApplyCns ("Position", in_rigModel & ".eff", "ValveGuide.NeckBase")
	...
	'head
	b1 = GetValue("ValveGuide.Neck0_bone.bone.length")
	b2 = GetValue("ValveGuide.Head_bone.bone.length")

	SetValue in_rigModel & ".Bip01_Neck1.bone.length", b1
	SetValue in_rigModel & ".Bip01_Head1.bone.length", b2

	c1 = ApplyCns ("Position", in_rigModel & ".Bip01_Neck1", "ValveGuide.NeckBase")
	...
	'arms
	b3 = GetValue("ValveGuide.R_Clavicle_bone.bone.length")
	b4 = GetValue("ValveGuide.R_UpperArm_bone.bone.length")
	b5 = GetValue("ValveGuide.R_Forearm_bone.bone.length")

	b6 = GetValue("ValveGuide.L_Clavicle_bone.bone.length")
	b7 = GetValue("ValveGuide.L_UpperArm_bone.bone.length")	
	b8 = GetValue("ValveGuide.L_Forearm_bone.bone.length")
...
Function AS_Attach_Hands(in_rigModel, out_valid)
	...
	b0 = GetValue("ValveGuide.R_Hand_bone.bone.length")	

	b1 = GetValue("ValveGuide.R_Finger0_bone.bone.length")
	b2 = GetValue("ValveGuide.R_Finger01_bone.bone.length")
	b3 = GetValue("ValveGuide.R_Finger02_bone.bone.length")

	b4 = GetValue("ValveGuide.R_Finger1_bone.bone.length")
	b5 = GetValue("ValveGuide.R_Finger11_bone.bone.length")
	b6 = GetValue("ValveGuide.R_Finger12_bone.bone.length")

	b7 = GetValue("ValveGuide.R_Finger2_bone.bone.length")	
	b8 = GetValue("ValveGuide.R_Finger21_bone.bone.length")
	b9 = GetValue("ValveGuide.R_Finger22_bone.bone.length")

	b10 = GetValue("ValveGuide.R_Finger3_bone.bone.length")
	b11 = GetValue("ValveGuide.R_Finger31_bone.bone.length")
	b12 = GetValue("ValveGuide.R_Finger32_bone.bone.length")

	b13 = GetValue("ValveGuide.R_Finger4_bone.bone.length")
	b14 = GetValue("ValveGuide.R_Finger41_bone.bone.length")
	b15 = GetValue("ValveGuide.R_Finger42_bone.bone.length")
	...
	SetValue in_rigModel & ".Bip01_R_Finger32.bone.length", b12*.5
	...
	MatchTransform in_rigModel & ".RThumbRoot", "ValveGuide.RThumb1"
	MatchTransform in_rigModel & ".RIndexRoot", "ValveGuide.RIndex1"
	MatchTransform in_rigModel & ".RMiddleRoot", "ValveGuide.RMiddle1"
	MatchTransform in_rigModel & ".RRingRoot", "ValveGuide.RRing1"
	MatchTransform in_rigModel & ".RPinkyRoot", "ValveGuide.RPinky1"	
	...
	'left hand
	'match the bone lengths
	b0 = GetValue("ValveGuide.L_Hand_bone.bone.length")	
	b1 = GetValue("ValveGuide.L_Finger0_bone.bone.length")
	b2 = GetValue("ValveGuide.L_Finger01_bone.bone.length")
	b3 = GetValue("ValveGuide.L_Finger02_bone.bone.length")

	b4 = GetValue("ValveGuide.L_Finger1_bone.bone.length")
	b5 = GetValue("ValveGuide.L_Finger11_bone.bone.length")
	b6 = GetValue("ValveGuide.L_Finger12_bone.bone.length")

	b7 = GetValue("ValveGuide.L_Finger2_bone.bone.length")	
	b8 = GetValue("ValveGuide.L_Finger21_bone.bone.length")
	b9 = GetValue("ValveGuide.L_Finger22_bone.bone.length")

	b10 = GetValue("ValveGuide.L_Finger3_bone.bone.length")
	b11 = GetValue("ValveGuide.L_Finger31_bone.bone.length")
	b12 = GetValue("ValveGuide.L_Finger32_bone.bone.length")

	b13 = GetValue("ValveGuide.L_Finger4_bone.bone.length")
	b14 = GetValue("ValveGuide.L_Finger41_bone.bone.length")
	b15 = GetValue("ValveGuide.L_Finger42_bone.bone.length")
	...
	SetValue in_rigModel & ".Bip01_L_Finger32.bone.length", b12*.5
	...
	MatchTransform in_rigModel & ".LThumbRoot", "ValveGuide.LThumb1"
	MatchTransform in_rigModel & ".LIndexRoot", "ValveGuide.LIndex1"
	MatchTransform in_rigModel & ".LMiddleRoot", "ValveGuide.LMiddle1"
	MatchTransform in_rigModel & ".LRingRoot", "ValveGuide.LRing1"
	MatchTransform in_rigModel & ".LPinkyRoot", "ValveGuide.LPinky1"	
...
Function AS_attach_feet(in_rigModel, out_valid)
	...
	b1 = GetValue("ValveGuide.R_Thigh_bone.bone.length")
	b2 = GetValue("ValveGuide.R_Calf_bone.bone.length")
	b3 = GetValue("ValveGuide.R_Foot_bone.bone.length")
	b4 = GetValue("ValveGuide.R_Toe0_bone.bone.length")
	b5 = GetValue("ValveGuide.L_Thigh_bone.bone.length")
	b6 = GetValue("ValveGuide.L_Calf_bone.bone.length")
	b7 = GetValue("ValveGuide.L_Foot_bone.bone.length")	
	b8 = GetValue("ValveGuide.L_Toe0_bone.bone.length")
	...
	set c3 = ApplyCns ("Position", in_rigModel & ".Bip01_R_Toe0", "ValveGuide.RBall")
	...
	set c7 = ApplyCns ("Position", in_rigModel & ".Bip01_L_Toe0", "ValveGuide.LBall")
...
Function attach_feet(in_rigModel, out_valid)
	...
	set lHeel = root.FindChild("ValveGuide.LBall")
	...
	set rHeel = root.FindChild("ValveGuide.RBall")
	...
	MatchTransform , "ValveGuide.RBall", siTrn
	MatchTransform in_rigModel & ".ankle1", "ValveGuide.RFoot", siTrn

	setuserpref("SI3D_CONSTRAINT_COMPENSATION_MODE"), 1
	MatchTransform in_rigModel & ".RightToe", "ValveGuide.RBall", siTrn
...
'' ws 11/8/2005 12:55PM
'' skip the following checks now that the tools are installed in a workgroup
...
''		end if
		...
		' ws 11/8/2005 12:54PM
		' check the current workgroups and match for ValveSource
		' TODO: check for multiple occurences of ValveSource?
		aWorkgroups = Application.Workgroups
		Application.LogMessage "-----Checking Workgroups-----"
		for i = 0 to ubound( aWorkgroups, 1 )
			set find = new RegExp
			find.Pattern = "ValveSource"
			dim matchWorkgroup
			matchWorkgroup = find.Test(aWorkgroups(i))
			if matchWorkgroup then
				Application.LogMessage "using workgroup:" + aWorkgroups(i)
				GetInstallDir = aWorkgroups(i)
				exit function
			end if
		next
