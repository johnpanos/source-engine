...
// game/server/portal2/prop_tractorbeam.h:20 sizeof=0x530 (i386)
...
protected:
	...
	CNetworkVar( float, m_flLinearForce ); // +0x520  // line 38
	CNetworkVar( Vector, m_vEndPos ); // +0x524  // line 39
};

// game/server/portal2/prop_tractorbeam.h:20 (declaration)
~CPropTractorBeamProjector();

// game/server/portal2/prop_tractorbeam.h:20 @0x76e490 _ZN25CPropTractorBeamProjectorD0Ev
CPropTractorBeamProjector::~CPropTractorBeamProjector()
{
}

// game/server/portal2/prop_tractorbeam.h:20 @0x76e4d0 _ZN25CPropTractorBeamProjectorD1Ev
CPropTractorBeamProjector::~CPropTractorBeamProjector()
{
}
