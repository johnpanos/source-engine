...
protected:
	...
	void PaintBlobMoveThroughPortal( float, CPortal_Base2D *, const Vector &, const Vector & );  // line 106
	...
	CBaseEntity *m_pOwner; // +0x38  // line 125
...
// game/shared/portal/paint_blobs_shared.h:268
typedef CUtlVector<BlobDataPerUpdate_t,CUtlMemory<BlobDataPerUpdate_t, int> > BlobDataPerUpdateVector_t;
