...
public:
	...
	PaintPowerInfo_t( const Vector &, const Vector &, CBaseEntity *, PaintPowerType, bool );  // line 46
};

// game/shared/portal/paint_power_info.h:28 (declaration)
~PaintPowerInfo_t();

// game/shared/portal/paint_power_info.h:28 (declaration)
void PaintPowerInfo_t( const PaintPowerInfo_t & );

// game/shared/portal/paint_power_info.h:28 (declaration)
void operator=( const PaintPowerInfo_t & );
