...
public:
	...
	$_178 m_iActivity; // +0x4  // line 83
	bool m_bAutoKill; // +0x8  // line 84
	bool m_bActive; // +0x9  // line 85
	CAnimationLayer *m_pAnimLayer; // +0xc  // line 86
};
...
// game/shared/multiplayer/multiplayer_animstate.h:155 sizeof=0xb0 (i386)
struct CMultiPlayerAnimState
{
public:
	int (**_vptr$CMultiPlayerAnimState)(); // +0x0  // line 0
	CMultiPlayerAnimState();  // line 161
	CMultiPlayerAnimState( CBasePlayer *, MultiPlayerMovementData_t & );  // line 162
	...
	$_178 GetCurrentMainActivity();  // line 185
...
protected:
	virtual void Init( CBasePlayer *, MultiPlayerMovementData_t & );  // line 199
	CBasePlayer *GetBasePlayer();  // line 200
	virtual int SelectWeightedSequence( $_178 );  // line 203
	virtual void RestartMainSequence();  // line 204
	void GetOuterAbsVelocity( Vector & );  // line 206
	float GetOuterXYSpeed();  // line 207
	virtual bool HandleJumping( $_178 & );  // line 209
	virtual bool HandleDucking( $_178 & );  // line 210
	virtual bool HandleMoving( $_178 & );  // line 211
	virtual bool HandleSwimming( $_178 & );  // line 212
	virtual bool HandleDying( $_178 & );  // line 213
	...
	bool IsGestureSlotPlaying( int, $_178 );  // line 220
	void AddToGestureSlot( int, $_178, bool );  // line 221
	void RestartGesture( int, $_178, bool );  // line 222
	...
	virtual void PlayFlinchGesture( $_178 );  // line 231
	...
	CBasePlayer *m_pPlayer; // +0x1c  // line 269
	...
	$_178 m_eCurrentMainSequenceActivity; // +0xa0  // line 303
	int m_nSpecificMainSequence; // +0xa4  // line 306
	CHandle<CBaseCombatWeapon> m_hActiveWeapon; // +0xa8  // line 309
	float m_flMaxGroundSpeed; // +0xac  // line 316
};
