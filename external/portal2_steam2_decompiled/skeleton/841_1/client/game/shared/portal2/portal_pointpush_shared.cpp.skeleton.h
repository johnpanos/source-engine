...
// None:0 @0x16a70 _Z41__static_initialization_and_destruction_0ii
...
// game/shared/portal2/portal_pointpush_shared.cpp:26 @0x1bc320 _ZN18C_Portal_PointPush9PushThinkEv
void C_Portal_PointPush::PushThink()
{
	PortalRadiusExtensionVector portalRadiusExtensions;  // line 29
	// inlined CUtlVector<PortalRadiusExtension_t,CUtlMemory<PortalRadiusExtension_t, int> >::~CUtlVector() at line 39
	{
		int i;  // line 32
		// inlined CUtlVector<PortalRadiusExtension_t,CUtlMemory<PortalRadiusExtension_t, int> >::operator[]() at line 34
		// inlined C_Portal_PointPush::PushAtPoint() at line 34
	}
...
// game/shared/portal2/portal_pointpush_shared.cpp:78 @0x1bbdf0 _ZN18C_Portal_PointPush14TestWithinConeERK6VectorS2_RK6QAnglef
...
// game/shared/portal2/portal_pointpush_shared.cpp:98 @0x1bbe90 _ZN18C_Portal_PointPush21PushPaintBlobsAtPointERK6VectorRK6QAngleP15C_Portal_Base2D
		...
		int i;  // line 104
		{
			...
			int numBlobs;  // line 115
			{
				int j;  // line 116
				{
					...
					// inlined C_Portal_PointPush::TestWithinCone() at line 146
					{
						float flMinAngle;  // line 138
						// inlined C_Portal_PointPush::TestWithinCone() at line 139
					}
				}
			}
		}
