...
// None:0 @0x81e50 _Z41__static_initialization_and_destruction_0ii
...
// game/client/portal2/hud_coop_ping_indicator.cpp:29 @0x601fd0 _ZN21CHudCoopPingIndicatorD0Ev
CHudCoopPingIndicator::~CHudCoopPingIndicator()
{
	// inlined CHudElement::operator delete() at line 29
}

// game/client/portal2/hud_coop_ping_indicator.cpp:29 @0x602060 _ZN21CHudCoopPingIndicatorD1Ev
CHudCoopPingIndicator::~CHudCoopPingIndicator()
{
}

// game/client/portal2/hud_coop_ping_indicator.cpp:30 @0x601d40 _ZN21CHudCoopPingIndicator17GetPanelClassNameEv
const char *CHudCoopPingIndicator::GetPanelClassName()
{
}

// game/client/portal2/hud_coop_ping_indicator.cpp:30 @0x601d50 _ZN21CHudCoopPingIndicator13KB_ChainToMapEv
void CHudCoopPingIndicator::KB_ChainToMap()
{
	vgui::PanelKeyBindingMap *map;  // line 30
}

// game/client/portal2/hud_coop_ping_indicator.cpp:30 @0x601db0 _ZN21CHudCoopPingIndicator19ChainToAnimationMapEv
void CHudCoopPingIndicator::ChainToAnimationMap()
{
	PanelAnimationMap *map;  // line 30
}

// game/client/portal2/hud_coop_ping_indicator.cpp:30 @0x601e10 _ZN21CHudCoopPingIndicator10ChainToMapEv
void CHudCoopPingIndicator::ChainToMap()
{
	vgui::PanelMessageMap *map;  // line 30
}

// game/client/portal2/hud_coop_ping_indicator.cpp:30 @0x601e80 _ZN21CHudCoopPingIndicator13GetMessageMapEv
vgui::PanelMessageMap *CHudCoopPingIndicator::GetMessageMap()
{
	vgui::PanelMessageMap *s_pMap;  // line 30
}

// game/client/portal2/hud_coop_ping_indicator.cpp:30 @0x601f10 _ZN21CHudCoopPingIndicator8GetKBMapEv
vgui::PanelKeyBindingMap *CHudCoopPingIndicator::GetKBMap()
{
	vgui::PanelKeyBindingMap *s_pMap;  // line 30
}

// game/client/portal2/hud_coop_ping_indicator.cpp:30 @0x601fa0 _ZN21CHudCoopPingIndicator10GetAnimMapEv
PanelAnimationMap *CHudCoopPingIndicator::GetAnimMap()
{
}

// game/client/portal2/hud_coop_ping_indicator.cpp:33 @0x601b30 _ZN21CHudCoopPingIndicatorC2EPKc
...
// game/client/portal2/hud_coop_ping_indicator.cpp:33 @0x601ca0 _ZN21CHudCoopPingIndicatorC1EPKc
CHudCoopPingIndicator::CHudCoopPingIndicator( const char *pElementName )
{
}

// game/client/portal2/hud_coop_ping_indicator.cpp:34 @0x601aa0 _ZN21CHudCoopPingIndicator4InitEv
...
// game/client/portal2/hud_coop_ping_indicator.cpp:35 @0x600f20 _ZN21CHudCoopPingIndicator9LevelInitEv
void CHudCoopPingIndicator::LevelInit()
{
}

// game/client/portal2/hud_coop_ping_indicator.cpp:36 @0x601970 _ZN21CHudCoopPingIndicator19ApplySchemeSettingsEPN4vgui7ISchemeE
void CHudCoopPingIndicator::ApplySchemeSettings( vgui::IScheme *scheme )
{
}

// game/client/portal2/hud_coop_ping_indicator.cpp:37 @0x601a00 _ZN21CHudCoopPingIndicator10ShouldDrawEv
...
// game/client/portal2/hud_coop_ping_indicator.cpp:38 @0x601950 _ZN21CHudCoopPingIndicator5PaintEv
void CHudCoopPingIndicator::Paint()
{
}

// game/client/portal2/hud_coop_ping_indicator.cpp:40 @0x600f50 _ZN21CHudCoopPingIndicator24MsgFunc_HudPingIndicatorER7bf_read
...
// game/client/portal2/hud_coop_ping_indicator.cpp:43 @0x6013e0 _ZN21CHudCoopPingIndicator17DrawIndicatorHintEv
...
// game/client/portal2/hud_coop_ping_indicator.cpp:51 @0x601cb0 _ZL28Create_CHudCoopPingIndicatorv
...
// game/client/portal2/hud_coop_ping_indicator.cpp:52 @0x6019b0 _Z48__MsgFunc_CHudCoopPingIndicator_HudPingIndicatorR7bf_read
