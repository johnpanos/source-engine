...
// None:0 @0x1e3b0 _Z41__static_initialization_and_destruction_0ii
...
// game/shared/portal2/damage_database.cpp:32 @0x1e350 _ZN14DamageDatabaseC2Ev
DamageDatabase::DamageDatabase()
{
	// inlined CUtlVector<DamageInfo,CUtlMemory<DamageInfo, int> >::CUtlVector() at line 33
}

// game/shared/portal2/damage_database.cpp:32 @0x244350 _ZN14DamageDatabaseC1Ev
DamageDatabase::DamageDatabase()
{
}

// game/shared/portal2/damage_database.cpp:37 @0x244240 _ZN14DamageDatabase18LevelInitPreEntityEv
void DamageDatabase::LevelInitPreEntity()
{
	{
		int i;  // line 39
	}
	// inlined DamageDatabase::PrecacheAssets() at line 47
}

// game/shared/portal2/damage_database.cpp:51 (declaration)
void GetDamageInfoVector( DamagedEntityType entityType );

// game/shared/portal2/damage_database.cpp:51 @0x242fd0 _ZNK14DamageDatabase19GetDamageInfoVectorE17DamagedEntityType
const DamageInfoVector &DamageDatabase::GetDamageInfoVector( DamagedEntityType entityType )
{
}

// game/shared/portal2/damage_database.cpp:57 @0x2437f0 _ZNK14DamageDatabase26FindPotentialDamageEffectsEPii17DamagedEntityTypeii
...
// game/shared/portal2/damage_database.cpp:93 (declaration)
void PrecacheAssets();

// game/shared/portal2/damage_database.cpp:93 @0x243720 _ZNK14DamageDatabase14PrecacheAssetsEv
void DamageDatabase::PrecacheAssets()
{
	{
		int damageInfoIndex;  // line 96
		{
			const DamageInfoVector &damageInfo;  // line 98
			{
				int i;  // line 99
				{
					int j;  // line 105
					// inlined CUtlVector<DamageInfo,CUtlMemory<DamageInfo, int> >::operator[]() at line 105
				}
				{
					int j;  // line 111
					// inlined CUtlVector<DamageInfo,CUtlMemory<DamageInfo, int> >::operator[]() at line 111
				}
			}
		}
	}
...
// game/shared/portal2/damage_database.cpp:120 @0x2438b0 _Z28ReadDamageCutoutDataFromFileR10CUtlVectorI10DamageInfo10CUtlMemoryIS0_iEEP11IFileSystemPKcPKh
...
// game/shared/portal2/damage_database.cpp:287 @0x243260 _Z21ParseStringToIntArrayPKcPii
...
// game/shared/portal2/damage_database.cpp:313 @0x243580 _Z27ParseStringToExclusionArrayPKcPA64_ci
...
// game/shared/portal2/damage_database.cpp:340 @0x243390 _Z21ParseStringToGibArrayPKcS0_PA64_ci
...
// game/shared/portal2/damage_database.cpp:367 @0x2430d0 _Z24ParseStringToEffectArrayPKcPA64_cPii
...
// game/shared/portal2/damage_database.cpp:439 @0x242ff0 _Z19ParseStringToVectorPKcR6Vector
...
// public/tier1/utlmemory.h:707 @0x244360 _ZN10CUtlMemoryI10DamageInfoiE4GrowEi
