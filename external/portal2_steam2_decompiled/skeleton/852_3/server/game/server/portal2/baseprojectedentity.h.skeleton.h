...
// game/server/portal2/baseprojectedentity.h:20 sizeof=0x41c (i386)
...
public:
	...
	void RecursiveProjection( bool, CBaseProjector *, CPortal_Base2D *, const Vector &, const QAngle &, int );  // line 47
...
private:
	CNetworkVar( int, m_iMaxRemainingRecursions ); // +0x418  // line 75
};

// game/server/portal2/baseprojectedentity.h:20 (declaration)
~CBaseProjectedEntity();

// game/server/portal2/baseprojectedentity.h:20 @0x6aed00 _ZN20CBaseProjectedEntityD0Ev
CBaseProjectedEntity::~CBaseProjectedEntity()
{
}

// game/server/portal2/baseprojectedentity.h:20 @0x6aed40 _ZN20CBaseProjectedEntityD1Ev
CBaseProjectedEntity::~CBaseProjectedEntity()
{
}

// game/server/portal2/baseprojectedentity.h:40 @0x6aece0 _ZNK20CBaseProjectedEntity13GetStartPointEv
const Vector &CBaseProjectedEntity::GetStartPoint()
{
}

// game/server/portal2/baseprojectedentity.h:41 @0x6aecf0 _ZNK20CBaseProjectedEntity11GetEndPointEv
const Vector &CBaseProjectedEntity::GetEndPoint()
{
}

// game/server/portal2/baseprojectedentity.h:42 @0x6aed60 _ZN20CBaseProjectedEntity15GetLengthVectorEv
