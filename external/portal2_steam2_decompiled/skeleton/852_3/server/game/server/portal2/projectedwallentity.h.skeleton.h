...
// game/server/portal2/projectedwallentity.h:25 sizeof=0x470 (i386)
...
private:
	...
	CPhysCollide *m_pWallCollideable; // +0x420  // line 82
	CNetworkVar( Vector, m_vWorldSpace_WallMins ); // +0x424  // line 85
	CNetworkVar( Vector, m_vWorldSpace_WallMaxs ); // +0x430  // line 86
	CNetworkVar( CHandle<CPortal_Base2D>, m_hColorPortal ); // +0x43c  // line 89
	CNetworkVar( float, m_flLength ); // +0x440  // line 92
	CNetworkVar( float, m_flHeight ); // +0x444  // line 93
	CNetworkVar( float, m_flWidth ); // +0x448  // line 94
	CNetworkVar( bool, m_bIsHorizontal ); // +0x44c  // line 96
	CNetworkVar( int, m_nNumSegments ); // +0x450  // line 99
	CNetworkVar( float, m_flSegmentLength ); // +0x454  // line 100
	CNetworkVar( float, m_flParticleUpdateTime ); // +0x458  // line 102
	CUtlVector<PaintPowerType,CUtlMemory<PaintPowerType, int> > m_PaintPowers; // +0x45c  // line 104
	int ComputeSegmentIndex( const Vector & ) const;  // line 106
};

// game/server/portal2/projectedwallentity.h:38 @0x6db430 _ZN20CProjectedWallEntity17ShouldSavePhysicsEv
