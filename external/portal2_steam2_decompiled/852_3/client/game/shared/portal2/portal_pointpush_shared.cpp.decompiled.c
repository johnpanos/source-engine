...
/* __static_initialization_and_destruction_0 at 00016740 */
...

{
  ...
  (&DAT_00c200bb)[unaff_EBX] = 0;
  (&DAT_00c200bc)[unaff_EBX] = 0;
  (&DAT_00c200bd)[unaff_EBX] = 0;
  (&DAT_00c200be)[unaff_EBX] = 0;
  *(undefined4 *)(&DAT_00c200bf + unaff_EBX) = 0;
  *(undefined4 *)(&DAT_00c200c3 + unaff_EBX) = 0;
  *(undefined4 *)(&DAT_00c200c7 + unaff_EBX) = 0x7f7fffff;
  *(undefined4 *)(&DAT_00c200cb + unaff_EBX) = 0x7f7fffff;
  *(undefined4 *)(&DAT_00c200cf + unaff_EBX) = 0;
  *(undefined4 *)(&DAT_00c200d3 + unaff_EBX) = 0;
  *(undefined4 *)(&DAT_00c200d7 + unaff_EBX) = 0;
  *(undefined4 *)(&DAT_00c200db + unaff_EBX) = 0;
  *(undefined4 *)(&DAT_00c200df + unaff_EBX) = 0x7f7fffff;
  *(undefined4 *)(&DAT_00c200e3 + unaff_EBX) = 0x7f7fffff;
  *(undefined4 *)(&DAT_00c200e7 + unaff_EBX) = 0x7f7fffff;
  *(undefined4 *)(&DAT_00c200eb + unaff_EBX) = 0x7f7fffff;
  *(undefined **)(&DAT_00c200ef + unaff_EBX) = &UNK_00b1b6b7 + unaff_EBX;
  ConVar::ConVar((ConVar *)(s_SortBuffer + unaff_EBX + 0x4b82f),(char *)(__tcf_6 + unaff_EBX + 1),
                 &UNK_00952ddb + unaff_EBX,0x6000,&UNK_00952d9f + unaff_EBX,in_stack_ffffffe8,
                 in_stack_ffffffec,in_stack_fffffff0,flags_1,unaff_ESI);
  uVar1 = *(undefined4 *)(&DAT_00b1a5cf + unaff_EBX);
  ___cxa_atexit(&UNK_0092a6ef + unaff_EBX,0,uVar1);
  ConVar::ConVar((ConVar *)(s_SortBuffer + unaff_EBX + 0x4b88f),&UNK_00952e1b + unaff_EBX,
                 &UNK_00941ebb + unaff_EBX,0x6000,&UNK_00952dfd + unaff_EBX,in_stack_ffffffe8,
                 in_stack_ffffffec,in_stack_fffffff0,flags_1,unaff_ESI);
  ___cxa_atexit(&UNK_0092a6cf + unaff_EBX,0,uVar1);
  return;
}
...

{
  ...
  ConVar::~ConVar((ConVar *)(extraout_ECX + 0x3ff7b8),in_stack_00000008);
  return;
}
...

{
  ...
  ___i686_get_pc_thunk_cx();
  ConVar::~ConVar((ConVar *)(extraout_ECX + 0x3ff838),in_stack_00000008);
  return;
}


/* C_Portal_PointPush::PushThink at 001bdb40 */
...

{
  ...
  (*(this->super_C_BaseEntity).super_IClientEntity.super_IClientUnknown.super_IHandleEntity.
    _vptr_IHandleEntity[0x9b])
            (this,*(float *)(**(int **)("Failed to get collision model (%d, %d), %s (%s)\n" +
                                       unaff_EBX + 6) + 0xc) +
                  *(float *)(*(int *)(&DAT_00b82ace + unaff_EBX) + 0x2c));
  if (-1 < local_30.m_Memory.m_nGrowSize) {
    ...
    if (local_30.m_Memory.m_pMemory != (PortalRadiusExtension_t *)0x0) {
      (**(code **)(*(int *)**(undefined4 **)
                ...
                ((int *)**(undefined4 **)
                          ("%d entities in bone setup array. Should have been cleaned up by now\n" +
                          unaff_EBX + 0x2a),local_30.m_Memory.m_pMemory);
    }
  }
  return;
}
...
/* C_Portal_PointPush::TestWithinCone at 001bd630 */
...
/* C_Portal_PointPush::PushPaintBlobsAtPoint at 001bd6d0 */
...

{
  ...
  do {
    this_00 = CPaintStreamManager::GetPaintStream
                        (*(CPaintStreamManager **)
                          ("C_BaseAnimating::BuildTransformations" + unaff_EBX + 0x1f),local_cc);
        ...
        if ((this_01 != (CBasePaintBlob *)0x0) &&
          ...
          if (fVar14 * fVar14 + fVar15 * fVar15 + fVar16 * fVar16 <= fVar1 * fVar1) {
            ...
            if (fVar8 != 0.0) {
              ...
              lVar13 = (longdouble)_cosf(*(float *)(unaff_EBX + 0x7f91f3) * fVar8);
              if (local_7c.x * local_70.x + local_7c.y * local_70.y + local_7c.z * local_70.z <
                  (float)lVar13) goto LAB_001bd790;
            }
            if (pPortal != (C_Portal_Base2D *)0x0) {
              ...
              pfVar12 = (float *)(*(pPortal->super_CPortalRenderable_FlatBasic).
                                   ...
                                   super_IClientUnknown.super_IHandleEntity._vptr_IHandleEntity[0xd]
                                 )(pPortal);
                    /* Unresolved local var: Vector res@[???] */
...
/* _GLOBAL__I_portal_pointpush_think_rate at 00016890 */
