...
//include the dlc2 stuff
DoIncludeScript( "choreo/dlc2_vo.nut", self.GetScriptScope() )
...
{
	printldebug("=========GladosPlayVcd Called!========="+arg)	
	local dingon = false
...
{
	local caveactors = array(27),ent,val,sc
	caveactors[0] = "@cave_exit_lift"
	caveactors[1] = "cave_a3_03_dummy"
	caveactors[2] = "cave_a3_03_dummy2"
	caveactors[3] = "cave_a3_03_dummy3"
	caveactors[4] = "cave_a3_03_exit"
	caveactors[5] = "cave_a3_03_lift_shaft"
	caveactors[6] = "cave_a3_03_waiting_room"
	caveactors[7] = "cave_a3_jump_intro_entrance"
	caveactors[8] = "cave_a3_jump_intro_interchamber"
	caveactors[9] = "cave_a3_jump_intro_second_chamber"
	caveactors[10] = "cave_a3_transition01_dummy"
	caveactors[11] = "cave_a3_transition01_dummy2"
	caveactors[12] = "cave_a3_transition01_dummy3"
	caveactors[13] = "cave_bomb_flings_chamber"
	caveactors[14] = "cave_bomb_flings_entrance"
	caveactors[15] = "cave_crazy_box_2nd_chamber"
	caveactors[16] = "cave_crazy_box_dummy_chamber"
	caveactors[17] = "cave_crazy_box_entrance"
	caveactors[18] = "cave_portal_intro_entrance"
	caveactors[19] = "cave_portal_intro_exit"
	caveactors[20] = "cave_portal_intro_office"
	caveactors[21] = "cave_portal_intro_whitepaint"
	caveactors[22] = "cave_speed_flings_entrance"
	caveactors[23] = "cave_speed_ramp_entrance"
	caveactors[24] = "cave_speed_ramp_inter_chamber"
	caveactors[25] = "cave_transition01_dummy_exit"
	caveactors[26] = "cave_transition01_welcome"

	foreach (val in caveactors)
	{
			ent=null
			ent = Entities.FindByName(ent, val)
			if (ent != null)
			{
				sc = ent.GetCurrentScene()
				if ( sc != null )	
				{
					EntFireByHandle( sc, "Cancel", "", 0, null, null )
				}	
			}
	}
}
...
{
	if (sp_a1_intro1_fizzler_triggered && !sp_a1_intro1_fizzler_said)
	{
		sp_a1_intro1_fizzler_said = true
		if (sp_a1_intro1_fizzler_passed)
		{
			GladosPlayVcd(630)
		}
		else
