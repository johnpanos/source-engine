...
function PullGladosHeadDownLoop()
{
	...
	// raise shield
	EntFire( "maintenance_pit_model", "setanimation", "sheildsup", 4, 0 )
	EntFire( "maintenance_pit_model", "setdefaultanimation", "sheildsup_idle", 4.1, 0 )
...
function PresentPotatos()
{
	...
	EntFire( "maintenance_pit_model", "setanimation", "potatos_open", 0, 0 )
...
{
	// wiggle potatos
	EntFire( "potatos_pincer", "setanimation", "3wave", 0, 0 )
	EntFire( "potatos_pincer", "setdefaultanimation", "reach1_idle", 0.1, 0 )
}
...
{
	// tap potatos gently on the elevator door
	EntFire( "potatos_pincer", "setanimation", "tap1", 0, 0 )
	EntFire( "potatos_pincer", "setdefaultanimation", "tap1_idle", 0.1, 0 )
}
...
{
	// tap potatos strongly on the elevator door
	EntFire( "potatos_pincer", "setanimation", "tap2", 0, 0 )
	EntFire( "potatos_pincer", "setdefaultanimation", "tap2_idle", 0.1, 0 )
}
...
{
	// Punch potatos through the glass and drop her, pull back
	EntFire( "potatos_pincer", "setanimation", "punch", 0, 0 )
	EntFire( "potatos_pincer", "setdefaultanimation", "pound_idle", 0.1, 0 )
...
{
	// Pound the elevator
	EntFire( "potatos_pincer", "setanimation", "pound", 0, 0 )
	EntFire( "potatos_pincer", "setdefaultanimation", "pound_idle2", 0.1, 0 )
}
...
{
	// Pound the elevator
	EntFire( "potatos_pincer", "setanimation", "pound2", 0, 0 )
	EntFire( "potatos_pincer", "setdefaultanimation", "pound_idle2", 0.1, 0 )
}
...
{
	// Pound the elevator
	EntFire( "potatos_pincer", "setanimation", "pound3", 0, 0 )
	EntFire( "potatos_pincer", "setdefaultanimation", "pound_idle2", 0.1, 0 )
}
...
{
	// Pound the elevator
	EntFire( "potatos_pincer", "setanimation", "pound4", 0, 0 )
	EntFire( "potatos_pincer", "setdefaultanimation", "pound_idle2", 0.1, 0 )
}
...
{
	// Pound the elevator
	EntFire( "potatos_pincer", "setanimation", "pound5", 0, 0 )
	EntFire( "potatos_pincer", "setdefaultanimation", "pound_idle2", 0.1, 0 )
}
