...
function WheatleyDarknessMissionBriefing()
{
	SpeakLineVcd( 553 )
}
...
function WheatleyGapJumpGoodJob()
{
	SpeakLineVcd( 566 )
}
...
function WheatleyPanelDropCompletion()
{
	//SpeakLineVcd( 574 ) // removed because it is incorrect for where it is in the map
}
