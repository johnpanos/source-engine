...
//mp_coop_catapult_wall_intro             
	...
	//PingIntroIntro
		...
		SceneTable["coop_ping_orange_success03"] <- {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_intro11.vcd"),postdelay=4.0,next="coop_portal_ping_intro",fireentity="relay_ping_2_move_on",fireinput="Trigger",firedelay=1.00}
