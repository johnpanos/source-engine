...
{
	//PlayVCD("scenes/npc/glados/sp_incinerator_01_11.vcd")
	//SpeakLine( 1000 )
	EntFire("@glados","RunScriptCode","GladosPlayVcd(301)", 0)
}

function JailbreakWheatlyHeyLady()
{
	//SpeakLine( 1001 )
	//EntFire(waitEntityFire,waitEntityInput,waitEntityParm, waitEntityDelay)
	EntFire("@glados","RunScriptCode","GladosPlayVcd(300)", 0)
}
...
function JailbreakWheatlyCloseChamber()
{
	//SpeakLine( 1019 )
	EntFire("@glados","RunScriptCode","GladosPlayVcd(305)", 0)
}
...
function WheatlyKeepMoving()
{
	//SpeakLine( 50 )
	EntFire("@glados","RunScriptCode","GladosPlayVcd(311)", 0)
}

function GladosEasyChamber()
{
	//SpeakLine( 52 )
	EntFire("@glados","RunScriptCode","GladosPlayVcd(306)", 0)
}

function WheatlyItsATrap()
{
	//SpeakLine( 54 )
	EntFire("@glados","RunScriptCode","GladosPlayVcd(307)", 0)
}
...
function WheatlyWatchYourHead()
{
	//SpeakLine( 61 )
	EntFire("@glados","RunScriptCode","GladosPlayVcd(309)", 0)
}

function GladosWatchYourHead()
{
	SpeakLine( 62 )
}
...
function GladosNeedToTest()
{
	//SpeakLine( 66 )
	EntFire("@glados","RunScriptCode","GladosPlayVcd(312)", 0)
}
