...
//	SpeakLine( 100 )
	...
	EntFire("spherebot_train_1_chassis_1","movetopathnode","spherebot_train_1_path_2",1.0)
	EntFire("spherebot_train_1_chassis_1","setspeedreal",50,1.01)
	EntFire("shaft_vista-elevator_1","setspeedreal","50",1.01)
}

function ElevatorOuch()
{
//	SpeakLine( 103 )
	EntFire("@glados","RunScriptCode","GladosPlayVcd(-3)", 0)
	EntFire("spherebot_train_1_chassis_1","movetopathnode","spherebot_train_1_path_4",1.0)
	EntFire("spherebot_train_1_chassis_1","setspeedreal",40,1.01)
	EntFire("shaft_vista-elevator_1","setspeedreal","40",1.01)
}
