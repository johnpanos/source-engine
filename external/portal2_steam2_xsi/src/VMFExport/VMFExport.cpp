...
extern "C"
#endif
XSI::CStatus VMFExportMenu_Init( XSI::CRef& in_ref )
{
	Context ctxt = in_ref;
...
extern "C"
#endif
CStatus VMFExport_Init( const XSI::CRef& in_context )
{
...
extern "C"
#endif
CStatus VMFExport_Execute( XSI::CRef& in_context )
{
	SMDExport();
	return CStatus::OK;
}
...
extern "C"
#endif
CStatus VMFExportProperty_Define( const CRef & in_Ctx )
{
	Application app ;
...
extern "C"
#endif
CStatus VMFExportProperty_DefineLayout( const CRef & in_Ctx )
{
...
extern "C"
#endif
CStatus ShowConcaveEdges_Init( const XSI::CRef& in_context )
{
	Context ctx(in_context);
	Command cmd(ctx.GetSource());
...
extern "C"
#endif
CStatus ShowConcaveEdges_Execute( XSI::CRef& in_context )
{
	using namespace XSI;
