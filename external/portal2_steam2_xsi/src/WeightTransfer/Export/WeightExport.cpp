...
extern "C"
#endif
XSI::CStatus WeightExportMenu_Init( XSI::CRef& in_ref )
{
...
extern "C"
#endif
XSI::CStatus OnWeightExport( XSI::CRef& in_ref )
{
	ExportImp();
	return XSI::CStatus::OK;
}
...
extern "C"
#endif
XSI::CStatus WeightExport_Init( const XSI::CRef& in_context )
{
...
extern "C"
#endif
XSI::CStatus WeightExport_Execute( XSI::CRef& in_context )
{
	ExportImp();
	return XSI::CStatus::OK;
}
...
extern "C"
#endif
XSI::CStatus WeightExportProperty_Define( const XSI::CRef & in_Ctx )
{
	XSI::Application app ;
...
XSI::CStatus	RebuildLayout( XSI::PPGLayout & oLayout );

#ifdef unix
extern "C"
#endif
XSI::CStatus WeightExportProperty_DefineLayout( const XSI::CRef & in_Ctx )
{
