...
extern "C"
#endif
XSI::CStatus WeightImportMenu_Init( XSI::CRef& in_ref )
{
...
extern "C"
#endif
XSI::CStatus OnWeightImport( XSI::CRef& in_ref )
{
	ImportImp();
	return XSI::CStatus::OK;
}
...
extern "C"
#endif
XSI::CStatus WeightImport_Init( const XSI::CRef& in_context )
{
...
extern "C"
#endif
XSI::CStatus WeightImport_Execute( XSI::CRef& in_context )
{
	ImportImp();
	return XSI::CStatus::OK;
}
...
extern "C"
#endif
XSI::CStatus WeightImportProperty_Define( const XSI::CRef & in_Ctx )
{
	XSI::Application app ;
...
extern "C"
#endif
XSI::CStatus WeightImportProperty_DefineLayout( const XSI::CRef & in_Ctx )
{
