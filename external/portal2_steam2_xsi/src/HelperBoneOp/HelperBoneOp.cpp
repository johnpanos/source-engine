...
XSIPLUGINCALLBACK CStatus HelperBoneOp_Init
(
	UpdateContext&	ctx,
	long mode
)
...
XSIPLUGINCALLBACK CStatus HelperBoneOp_Term
(
	UpdateContext&	ctx,
	long 		mode
)
...
XSIPLUGINCALLBACK CStatus HelperBoneOp_Update
(
	UpdateContext&	ctx,
	OutputPort&	output
)
...
{ 
	...
	for ( long iRow=0; iRow < cRows; iRow++ )
	{
		long iCell=0;
