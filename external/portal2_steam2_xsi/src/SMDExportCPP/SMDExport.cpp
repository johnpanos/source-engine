...
extern "C"
#endif
CStatus SMDExport2_Init( const XSI::CRef& in_context )
{
...
extern "C"
#endif
CStatus SMDExportBatch_Init( const XSI::CRef& in_context )
{
	Context ctx(in_context);
	Command cmd(ctx.GetSource());
...
extern "C"
#endif
CStatus SMDExport2_Execute( XSI::CRef& in_context )
{
...
extern "C"
#endif
CStatus SMDExportBatch_Execute( XSI::CRef& in_context )
{
	SMDExport();
	return CStatus::OK;
}
...
extern "C"
#endif
CStatus SMDExportProperty2_Define( const CRef & in_Ctx )
{
	Application app ;
...
extern "C"
#endif
CStatus SMDExportProperty2_DefineLayout( const CRef & in_Ctx )
{
