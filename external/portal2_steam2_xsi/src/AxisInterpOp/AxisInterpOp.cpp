...
extern "C"
#endif
CStatus CppAxisInterpOp_Update
(
	UpdateContext&	ctx,
	OutputPort&	output
)
...
CStatus CAxisInterpOp::Init(UpdateContext& ctx, long )
{
	// clean up
	if ( m_aWeights )
		delete []m_aWeights;
