...
extern "C"
#endif
CStatus VMFImport_Init( const XSI::CRef& in_context )
{
...
extern "C"
#endif
CStatus VMFImport_Execute( XSI::CRef& in_context )
{
	VMFImport();
	return CStatus::OK;
}
...
extern "C"
#endif
CStatus VMFImportProperty_Define( const CRef & in_Ctx )
{
	Application app ;
...
extern "C"
#endif
CStatus VMFImportProperty_DefineLayout( const CRef & in_Ctx )
{
