...
# Replace the SetMode body
def replace_func(match):
    return """CreateInterfaceFn CShaderDeviceMgrVulkan::SetMode( void *hWnd, int nAdapter, const ShaderDeviceInfo_t& mode )
{
...
content = re.sub(r'CreateInterfaceFn CShaderDeviceMgrVulkan::SetMode.*?\}', replace_func, content, flags=re.DOTALL)
