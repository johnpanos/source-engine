...
//
//
// Portal 2 port: logic_random_outputs, ported unchanged from the CS:GO source drop;
// the repository's provenance and distribution warning applies. OnTriggerChance%d is read with a zero-based index, as in the
// retail Portal 2 server (CLogicRandomOutputs::KeyValue starts its counter at 0).
//
//=============================================================================
