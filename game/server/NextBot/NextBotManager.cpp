...
{
public:
	NextBotResponseNotifyScan( CBaseCombatCharacter *who, AIConcept_t speechConcept, AI_Response *response ) : m_who( who ), m_concept( speechConcept ), m_response( response )
	{
	}
 ...
 */
void NextBotManager::OnSpokeConcept( CBaseCombatCharacter *who, AIConcept_t speechConcept, AI_Response *response )
{
	NextBotResponseNotifyScan notify( who, speechConcept, response );
	TheNextBots().ForEachBot( notify );
