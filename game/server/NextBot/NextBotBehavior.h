...
public:
	...
	virtual EventDesiredResult< Actor > OnSpokeConcept( Actor *me, CBaseCombatCharacter *who, AIConcept_t speechConcept, AI_Response *response )	{ return TryContinue(); }
...
private:
	...
	virtual void OnSpokeConcept( CBaseCombatCharacter *who, AIConcept_t speechConcept, AI_Response *response )	{ PROCESS_EVENT_WITH_3_ARGS( OnSpokeConcept, who, speechConcept, response ); }
