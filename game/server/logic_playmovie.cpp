...
// The client plays the movies through the playvideo_* commands in
// game/client/portal2/portal2_video_panels.cpp and answers with "end_movie",
// which CPortal_Player turns into __MovieFinished.
//
//===========================================================================//
...
void CLogicPlayMovie::InputPlayMovieForAllPlayers( inputdata_t &data )
{
	...
	// Portal 2 port: this engine has no split-screen players (IVEngineServer has
	// no IsSplitScreenPlayer), so every connected player gets its own movie.
	bool bSplit = false;
