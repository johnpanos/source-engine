...
#ifdef PORTAL
	bool			CanSeeEntityThroughPortal( const CSightPortal *pPortal, CBaseEntity *pSightEnt ); // more expensive cone & raycast test
#endif
...
#ifdef PORTAL
	bool 			LookThroughPortal( const CSightPortal *pPortal, CBaseEntity *pSightEnt );
#endif
