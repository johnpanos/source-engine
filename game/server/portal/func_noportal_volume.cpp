...
#ifdef PORTAL2
// The Portal 2 client keeps its own list of these volumes (c_func_noportal_volume.cpp).
	...
	if( iPortalCount != 0 )
	{
		...
		for( int i = 0; i != iPortalCount; ++i )
		{
			...
			if( pTempPortal->m_bActivated && 
				IsOBBIntersectingOBB( pTempPortal->GetAbsOrigin(), pTempPortal->GetAbsAngles(), PORTAL_LOCAL_MINS( pTempPortal ), PORTAL_LOCAL_MAXS( pTempPortal ), 
