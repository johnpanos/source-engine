...
// $NoKeywords: $
//
// Portal 2 port: func_instance_io_proxy relays instance I/O (OnProxyRelayN) in the
// retail Portal 2 maps. Ported from the CS:GO source drop; the repository's provenance and distribution warning applies.
// The source's second, duplicate m_OnProxyRelay16 datadesc entry is dropped.
//
//=============================================================================//
