...
public:
	...
	ConceptInfo_t *GetConceptInfo( AIConcept_t speechConcept );
	void OnSpokeConcept( CAI_PlayerAlly *pPlayerAlly, AIConcept_t speechConcept, AI_Response *response  );
	...
	bool ConceptDelayExpired( AIConcept_t speechConcept );
...
public:
	...
	virtual void PostSpeakDispatchResponse( AIConcept_t speechConcept, AI_Response *response );
	...
	bool 		SelectSpeechResponse( AIConcept_t speechConcept, const char *pszModifiers, CBaseEntity *pTarget, AISpeechSelection_t *pSelection );
	void		SetPendingSpeech( AIConcept_t speechConcept, AI_Response *pResponse );
	...
	bool		ShouldSpeakRandom( AIConcept_t speechConcept, int iChance );
	bool		IsAllowedToSpeak( AIConcept_t speechConcept, bool bRespondingToPlayer = false );
	virtual bool SpeakIfAllowed( AIConcept_t speechConcept, const char *modifiers = NULL, bool bRespondingToPlayer = false, char *pszOutResponseChosen = NULL, size_t bufsize = 0 );
	...
	void		OnSpokeConcept( AIConcept_t speechConcept, AI_Response *response );
