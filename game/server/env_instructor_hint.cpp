...
// Portal 2 port: the client's c_gameinstructor.cpp defines this replicated
// ConVar; CS:GO defined the server half in cs_gamerules.cpp, which this game
// does not build, so the server half lives with the hint entity.
...
{
	// Portal 2 port: this IGameEventManager2 has no event-name lookup cookie.
