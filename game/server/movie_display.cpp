...
//
//
// Portal 2 port: vgui_movie_display, from the CS:GO source drop; the repository's provenance and distribution warning applies.
// "forceprecache" adds the movie to the server's Movies string table.
//
//=====================================================================================//
...
void CMovieDisplay::RestoreControlPanels( void )
{
	...
	for ( nPanel = 0; true; ++nPanel )
	{
		...
		// Portal 2 port: the source dereferenced a NULL screen when none matched.
