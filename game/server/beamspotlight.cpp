...
// $NoKeywords: $
//
// Portal 2 port: beam_spotlight (server half; the beam is drawn by C_BeamSpotLight).
// Ported from the CS:GO source drop; the repository's provenance and distribution warning applies.
//
//=============================================================================//
...
, m_isReversed( false )
{
	// Portal 2 port: this engine's network vars cannot be constructed from a value.
