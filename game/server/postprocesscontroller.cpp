...
// The player here has no m_hPostProcessCtrl, so the per-player controller hook
// at the end of LevelInitPostEntity is not ported; clients use the master controller.
//
//=============================================================================
