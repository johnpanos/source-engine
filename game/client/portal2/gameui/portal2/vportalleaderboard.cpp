...
ConVar cl_leaderboard_fake_no_data( "cl_leaderboard_fake_no_data", "0", FCVAR_DEVELOPMENTONLY );
ConVar cl_leaderboard_fake_io_error( "cl_leaderboard_fake_io_error", "0", FCVAR_DEVELOPMENTONLY );
