...
void CPortalRenderTargets::InitClientRenderTargets( IMaterialSystem* pMaterialSystem, IMaterialSystemHardwareConfig* pHardwareConfig )
{
	...
	// Portal 2 port: this base class sets them up in its sized InitClientRenderTargets() overload.
	BaseClass::InitClientRenderTargets( pMaterialSystem, pHardwareConfig, nWaterRenderTargetResolution, 256 );
