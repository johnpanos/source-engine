...
// Portal 2 port: CHudMessage is private to message.cpp here (no message.h);
// Mod_HiddenByOtherElements looks it up by name through gHUD instead.
...
bool C_GameInstructor::Mod_HiddenByOtherElements( void )
{
	...
	CHudElement *pHudMessage = gHUD.FindElement( "CHudMessage" );
