//========= Portal 2 port ======================================================//
//
// Purpose: vscript_client.nut as a byte array for VScriptClientInit().
//
// Generated from game/client/vscript_client.nut in the format of the CS:GO
// build step (devtools/bin/texttoarray.pl, which writes <name>_nut.h into the
// intermediate directory). The array below is byte-identical to that script's
// output. Regenerate it whenever the .nut changes, from the repository root:
//   perl <cstrike15_src>/devtools/bin/texttoarray.pl game/client/vscript_client.nut \
//       g_Script_vscript_client
// and keep this header comment.
//
//=============================================================================//
