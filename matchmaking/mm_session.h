...
// Portal 2 port: only the offline session is built. The online sessions
// (sys_session, online host/client/search/teamsearch, dedicated and match
// searchers) need INetSupport and lobby services this engine does not have;
// see MM_PORTAL2_ONLINE_SESSIONS in mm_portal2_compat.h.
...
#endif // MM_PORTAL2_ONLINE_SESSIONS
