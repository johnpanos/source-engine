...
void CMatchExtensions::OnExtensionInterfaceUpdated( char const *szInterfaceString, void *pvInterface )
{
	...
	{
		// Portal 2 port: this engine's localizer is the vgui one.
		{ VGUI_LOCALIZE_INTERFACE_VERSION,	(Ext_t) &Exts_t::m_pILocalize },
		...
		// Portal 2 port: the server host adapter replaces INetSupport and IServerGameDLL.
		{ IMATCHSERVERHOST_PORTAL2_INTERFACE,	(Ext_t) &Exts_t::m_pIMatchServerHost },
