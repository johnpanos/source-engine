...
./hl2_launcher -game portal -windowed -w 1920 -h 1080 -novid -insecure -renderer vulkan-compat +mat_queue_mode 0 +fps_max 120 +map testchmb_a_01 -physics box3d "$@"
