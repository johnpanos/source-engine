...
#define Sys_GetFactoryWithContext				MAKE_NAME_UNIQUE(Sys_GetFactoryWithContext)
#define Sys_SetModuleLoadTelemetrySink			MAKE_NAME_UNIQUE(Sys_SetModuleLoadTelemetrySink)
#define Sys_RecordModuleLoad						MAKE_NAME_UNIQUE(Sys_RecordModuleLoad)
#define Sys_RecordModuleEntryPoint				MAKE_NAME_UNIQUE(Sys_RecordModuleEntryPoint)
#define Sys_RecordModuleInterface				MAKE_NAME_UNIQUE(Sys_RecordModuleInterface)
#define Sys_RecordModuleUnload					MAKE_NAME_UNIQUE(Sys_RecordModuleUnload)
#define Sys_LoadInterface						MAKE_NAME_UNIQUE(Sys_LoadInterface)
#define Sys_LoadInterfaceWithContext			MAKE_NAME_UNIQUE(Sys_LoadInterfaceWithContext)
#define Sys_LoadModule							MAKE_NAME_UNIQUE(Sys_LoadModule)
#define Sys_LoadModuleWithContext				MAKE_NAME_UNIQUE(Sys_LoadModuleWithContext)
#define Sys_UnloadModule						MAKE_NAME_UNIQUE(Sys_UnloadModule)
#define Sys_UnloadModuleWithContext				MAKE_NAME_UNIQUE(Sys_UnloadModuleWithContext)
#define CScopedModuleLoadRequest					MAKE_NAME_UNIQUE(CScopedModuleLoadRequest)
