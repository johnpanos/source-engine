...
// Source Engine port: only the Squirrel language is imported. GameMonkey,
// Lua and Python are not part of this module; their branches below stay
// disabled unless their *_ENABLED switch and implementation are supplied.
